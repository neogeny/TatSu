...
The source code for {{TatSu}} is posted to its [repository](https://github.com/neogeny/TatSu) on Github. Bug reports, patches, suggestions, and improvements are welcome.

If you want to contribute to the development of {{TatSu}}, follow the instructions below to create an environment in which {{TatSu}} can be tested.
...
- [uv](https://docs.astral.sh/uv/) as project environment manager (see the [uv installation instructions](https://docs.astral.sh/uv/getting-started/installation/)).
- [make](https://www.gnu.org/software/make/manual/make.html) to execute the predefined development, testing, and packaging tasks.

There is support for `Makefile` in several console environments, and also in popular IDEs lie [PyCharm](https://www.jetbrains.com/pycharm/) and [VSCode](https://code.visualstudio.com). If you don't want to use [make](https://www.gnu.org/software/make/manual/make.html) you can still read the actiions in the `Makefile` and execute them manually.
...
- **./docs/** the [Sphinx](https://www.sphinx-doc.org/en/master/) documentation
...
Use [uv](https://docs.astral.sh/uv/) to create and configure a [Python](http://python.org) environment with the libraries required for development and testing:
...
The `Makefile` defines the running of all static analysis, typing, and unit tests as the default:
...
[![sponsor](https://img.shields.io/badge/Sponsor-EA4AAA?label=TatSu)](https://github.com/sponsors/neogeny)  
[![paypal](https://img.shields.io/badge/Ko--fi-F16061?style=for-the-badge&logo=ko-fi&logoColor=white&label=TatSu){height="20px"}](https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=2TW56SV6WNJV6)

If you\'d like to contribute to the future development of {{TatSu}}, please [make a donation](https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=2TW56SV6WNJV6) to the project.
