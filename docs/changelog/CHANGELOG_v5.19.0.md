...
- The file extension for **TatSu** grammars is now `.ebnf`. The grammar language is, after all, an _extension_ of the most known forms of EBNF syntax. Syntax highlighters may recognize the extension
