...
|TatSu| **TatSu** is *different* from other `PEG`_ parser generators:

-  Generated parsers use `Python`_'s very efficient exception-handling
   system to backtrack. |TatSu| **TatSu** generated parsers simply assert what
...
-  The use of `Python`_'s `context managers`_ considerably reduces the
   ...
   CPU-cache hits.
-  Include files, rule inheritance, and rule inclusion give |TatSu| **TatSu**
...
|TatSu| **TatSu** is feature-complete and currently being used with complex
