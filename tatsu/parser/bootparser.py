        ...
        Rule(
          ...
          exp=Sequence(
            [
              ...
              OverrideList(Call('firstoption')),
              Cut(),
              Closure(Sequence([Token('|'), Cut(), OverrideList(Call('firstoption'))]))
            ]
          ),
          params=['FirstChoice'],
          kwparams={},
        ...
        Rule(
          ...
          exp=Sequence(
            [
              Pattern('(?ms)\\?/((?:[^/\\\\]|\\\\/|\\\\.)*)/\\?'),
              Cut(),
              Alert(literal='deprecated regex syntax', level=2)
            ]
          ),
          params=(),
          kwparams={},
