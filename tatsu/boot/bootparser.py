    ...
    Grammar(
      ...
      rules=(
              ...
              Group(
                Choice(
                  [
                    Sequence(
                      [
                        Named(name='name', exp=Group(Choice([Token('comments'), Token('eol_comments')]))),
                        Cut(),
                        Token('::'),
                        Cut(),
                    ...
                    Sequence(
                      [
                        ...
                        Named(
                          name='value',
                          exp=Group(
                            Choice([Call('regex'), Call('string'), Token('None'), Token('False'), Constant()])
                          )
                        )
                      ]
                    ),
                ...
                Choice(
                  [
                    ...
                    PositiveClosure(
                      Sequence(
                        [
                          OverrideList(Group(Choice([Call('word'), Call('string')]))),
                          NegativeLookahead(Group(Choice([Token(':'), Token('=')])))
                        ]
                      )
                    )
                  ]
        ...
        Rule(
          ...
          exp=Sequence(
            [
              ...
              Cut(),
              Group(Choice([Call('positive_gather'), Call('normal_gather')]))
            ]
          )
        ),
        Rule(
        ...
        Rule(
          ...
          exp=Sequence(
            [
              Lookahead(Group(Sequence([Call('atom'), Token('%{')]))),
              Cut(),
              Group(Choice([Call('positive_join'), Call('normal_join')]))
            ]
          )
        ),
        Rule(
          ...
          exp=Choice(
            [
              ...
              Sequence(
                [
                  Override(Call('atom')),
                  NegativeLookahead(Group(Choice([Token('?"'), Token("?'"), Token('?/')]))),
                  Token('?'),
                  Cut()
                ]
              )
        ...
        Rule(
          ...
          exp=Sequence(
            [
              Lookahead(Group(Choice([Token('"'), Token("'")]))),
              Group(
          ...
          exp=Choice(
            [
              ...
              Sequence(
                [
                  NegativeLookahead(Token('?/')),
                  Group(Choice([Call('REGEX'), Sequence([Token('?'), Override(Call('STRING'))])]))
                ]
              )
            ]
          )
        ...
        Rule(
          ...
          is_memo=True,
          is_lrec=False,
          exp=Pattern('-?(?:0|[1-9][0-9]*)(?:\\.[0-9]+)?(?:[eE][+-]?[0-9]+)?')
        ),
        Rule(
          name='true',
          params=(),
