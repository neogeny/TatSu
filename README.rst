...
.. note::
    If you need support for previous versions of Python, please consider |TatSu-LTS|_, a friendly fork
    of |TatSu| aimed at compatibility with other versions of Python still used by
